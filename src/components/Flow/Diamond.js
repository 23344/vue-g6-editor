  ...
  init() {
    G6.registerNode("customDiamond", {
      draw(cfg, group) {
        ...
        const mainId = 'customDiamond' + uniqueId()
        const shape = group.addShape("polygon", {
          attrs: {
            ...
            points:[[offsetX+width/2, offsetY ], [offsetX+width, height/2+offsetY], [offsetX+width/2, height+offsetY], [offsetX, height/2+offsetY]],
